...
$(document).ready(function($) {
    ...
    function animateElements() {
        $('.circle-bar2').each(function() {
            ...
            if (elementPos < topOfWindow + $(window).height() - 30 && !animate) {
                ...
                $(this).find('.circle-graph2').circleProgress({ value: percent / 100, size: 400, thickness: 30, fill: { color: '#2E37A4' } });
            }
        });
    }
    ...
    $(document).on('click', '#open_msg_box', function() { $wrapper.toggleClass('open-msg-box'); return false; });
    ...
    if ($('#drop-zone').length > 0) {
        ...
        dropZone.ondragleave = function() { this.className = 'upload-drop-zone'; return false; };
    }
    if (screen.width >= 992) {
    ...
    $(".links-info-one").on('click', '.service-trash1', function() { $(this).closest('.links-cont').remove(); return false; });
